...
def get_video_metadata(file_path):
    try:
        cmd = [r'C:\Users\mdzhs\OneDrive\Documents\Programming Projects\MovieLibraryViewer\MovieLibraryViewer\src\main\java\m\hossam\movielibraryviewer\exiftool.exe', file_path]
...
def extract_metadata_for_directory(video_directory, output_folder, mode):
...
output_folder = r'C:\\My_Data\\Movies\\Movie_Metadata'
extract_metadata_for_directory(video_directory, output_folder, 'no_overwrite')
